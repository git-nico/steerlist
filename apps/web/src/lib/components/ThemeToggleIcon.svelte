...
<svg class={className} aria-hidden="true" viewBox="0 0 24 24" {...restProps}>
...
<style>
	/* only show the toggle when javascript is enabled */
	:global(html:not([data-theme]):not(.dark)) svg {
		visibility: hidden;
	}
